...
const Dialogs = (props) => {
    debugger;
    let dialogElement = props.messagePage.DialogsData.map(d => <DialogItem nameUser={d.nameUser} id={d.id}/>)
    let messageElement = props.messagePage.MessageData.map(m => <Message message={m.message} id={m.id}/>)
